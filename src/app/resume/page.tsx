...
const educationData = [
  ...
  },
  {
    ...
    startDate: "2014",
    endDate: "2018",
    description: "Graduated with honors. Participated in various hackathons and coding competitions. Member of the Computer Science Student Association.",
  },
];
...
const experienceData = [
  {
    ...
    startDate: "Jan 2022",
    endDate: "Present",
    description: "Leading the development of the company's flagship product, a cloud-based project management tool.",
    responsibilities: [
  ...
  },
  {
    ...
    startDate: "Jun 2020",
    endDate: "Dec 2021",
    description: "Worked on developing and maintaining data visualization dashboards for enterprise clients.",
    responsibilities: [
  ...
  },
  {
    ...
    startDate: "May 2019",
    endDate: "Aug 2019",
    description: "Summer internship focused on front-end development for a fintech startup.",
    responsibilities: [
      ...
      <Card>
        <CardContent className="p-6">
          ...
          <p className="text-muted-foreground">
            ...
            Strong problem-solving skills and a passion for creating clean, efficient, and maintainable code. 
